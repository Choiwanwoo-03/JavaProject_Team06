...
public class AddAction_Gui_test extends JPanel {
    ...
    // 행동 목록 및 CO2e 계수
    private static final Map<String, List<String>> actionData = new HashMap<String, List<String>>();
    private static final Map<String, Double> co2eFactors = new HashMap<String, Double>();
